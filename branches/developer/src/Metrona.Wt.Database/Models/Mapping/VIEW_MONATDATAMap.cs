...
namespace Metrona.Wt.Database.Models.Mapping
{
    ...
    public class VIEW_MONATDATAMap : EntityTypeConfiguration<VIEW_MONATDATA>
    {
        public VIEW_MONATDATAMap()
        {
            // Primary Key
            this.HasKey(t => new { t.WSCODE, t.MoTG });
