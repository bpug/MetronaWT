...
<asp:CompareValidator ID="DateFormatValidator1" runat="server" ControlToValidate="TextBox1"
                                              CssClass="text-danger" Display="None" ErrorMessage="Geben Sie bitte ein gültiges Datum im Format TT.MM.JJJJ ein." Operator="DataTypeCheck"
                                              SetFocusOnError="True" ToolTip="Geben Sie bitte ein gültiges Datum im Format TT.MM.JJJJ ein." Type="Date" ValidationGroup="vgKlima">
